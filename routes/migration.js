...
module.exports = function initMigrationRoutes(app) {
  ...
  // Get all migrations
  //
  app.get('/api/logged-in/admin/migrations/all', function (req, res) {
  ...
  // Get migration by id
  //
  app.get('/api/logged-in/migration/:migration_id', function (req, res) {
  ...
  //
  app.post('/api/logged-in/migration/:migration_id/edit', function (req, res) {
  ...
  //
  app.delete('/api/logged-in/migration/:migration_id/delete', function (req, res) {
