...
function mapDispatchToProps(dispatch) {
  return {
    notificationRequest: (title, description, persistence, selectedUsers, isGroup) => dispatch(notificationRequest(title, description, persistence, selectedUsers, isGroup)),
