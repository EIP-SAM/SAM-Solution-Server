    ...
    return (
      <Table responsive hover striped>
        ...
        {data.map((group, index) => {
          ...
          actionEdit.push(<ButtonPopover key={`action-${0}`} link={`/edit-group/${group.id}`} trigger="hover" placement="bottom" popoverContent="Edit Group" buttonType="link" icon="pencil" />);
